...
/**
 * @file
 * Contains \Drupal\system\Form\LeafletMoreMapsForm.
 */
...
class LeafletMoreMapsSettingsForm extends SystemConfigFormBase {
  ...
  public function submitForm(array &$form, array &$form_state) {
    ...
    $config = $this->configFactory->get('leaflet_more_maps.settings');
    $config->set('leaflet_more_maps_custom_maps', $custom_maps)->save();

    // Refresh cache table or hook_leaflet_map_info() won't be called.
    //cache_clear_all($cid ='*', $bin='cache', TRUE);
    cache()->deleteAll();
